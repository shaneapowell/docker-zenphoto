...
$conf['mysql_user'] = getenv('MYSQL_USER');           // Supply your Database user id.
$conf['mysql_pass'] = getenv('MYSQL_PASS');           // Supply your Database password.
$conf['mysql_host'] = getenv('MYSQL_HOST');  // Supply the name of your Database server.
$conf['mysql_database'] = getenv('MYSQL_DB');       // Supply the name of Zenphoto's database
$conf['mysql_prefix'] = getenv('MYSQL_PREFIX'); // If you're sharing the database with other tables, use a prefix to be safe.
$conf['mysql_port'] = getenv('MYSQL_PORT'); // Change if your server uses a different port
$conf['mysql_socket'] = "";
...
////////////////////////////////////////////////////////////////////////////////
$conf['site_upgrade_state'] = getenv('ZP_UPGRADE_STATE');
